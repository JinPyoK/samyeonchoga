  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        _renderTitle('1. 사면초가'),
        _renderDescription(
            '사면초가는 사방에서 초나라 노래가 흘러나온다는 뜻으로, 사면이 모두 적에게 포위되거나, 누구의 지지나 도움도 받을 수 없어 고립된 상태를 이르는 말입니다. 이 게임은 초나라의 기물이 계속해서 부활하며 한나라(유저)의 왕을 노릴 것입니다. 유저는 끊임없이 쏟아져 나오는 초나라 병사들을 막아야 하며, 골드를 이용하여 기물을 부활 및 처형할 수 있습니다. 최대한 오래 버티세요!'),
        _renderTitle('2. 골드'),
        _renderDescription(
            '골드는 최대 3000골드를 가지고 게임을 시작할 수 있으며, 기물을 부활 및 처형할 때 골드를 소모해야 하고, 초나라 기물을 취하면 소량의 골드를 획득합니다. 게임 중 남은 골드는 모두 돌려받습니다. 앱을 삭제하면 내가 열심히 모은 골드는 사라지므로 주의해주세요! 아래 Ad 탭에서 광고를 시청하시면 1000골드를 보상으로 받으실 수 있습니다.'),
        _renderTitle('3. 게임 시작'),
        _renderDescription(
            '최소 0골드, 최대 3000골드로 게임을 시작할 수 있습니다. 유저는 무조건 한나라에서 플레이 하게 됩니다. 포진을 자유롭게 선택하여 주시면 됩니다. 초나라의 포진은 랜덤입니다.'),
        _renderTitle('4. 대국'),
        _renderDescription(
        ...
        _renderDescription(
            '한나라의 왕이 초나라의 기물로부터 취해졌을 때 게임이 종료됩니다. 또는 도중에 게임을 저장한 후, 추후 저장했던 게임을 다시 시작할 수 있습니다. 골드와 마찬가지로, 앱을 삭제하면 저장했던 게임이 사라집니다.'),
        _renderTitle('8. 랭크'),
        _renderDescription(
