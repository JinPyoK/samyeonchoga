...
final class BlueChaModel extends BluePieceBaseModel {
  ...
  void searchActionable() {
    ...
    if (x == 3 && y == 7) {
      ...
      findBlueActions(getStatus(3, 7), pieceActionable);
      findBlueActions(getStatus(5, 7), pieceActionable);
      findBlueActions(getStatus(3, 9), pieceActionable);
      findBlueActions(getStatus(5, 9), pieceActionable);
    } else if (x == 3 && y == 9) {
